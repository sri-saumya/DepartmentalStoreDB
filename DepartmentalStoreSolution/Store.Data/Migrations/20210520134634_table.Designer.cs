...
namespace Store.Data.Migrations
{
    ...
    [Migration("20210520134634_table")]
    partial class table
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Store.Domain.Product", b =>
                {
                    b.HasOne("Store.Domain.ProductHistory", "ProductHistory")
                        .WithOne("Product")
                        .HasForeignKey("Store.Domain.Product", "ProductHistoryId")
            ...
            modelBuilder.Entity("Store.Domain.Staff", b =>
                {
                    b.HasOne("Store.Domain.Address", "Address")
                        .WithOne("Staff")
                        .HasForeignKey("Store.Domain.Staff", "AddressId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
